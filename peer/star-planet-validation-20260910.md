...
- `peer/common`, `peer/star`, `peer/planet` 共用 Cargo workspace、锁文件和帧/身份/保活实现.
...
审查路径包括 `peer/star/src/server.rs`, `peer/planet/src/server.rs`, `peer/common/src/{connection,registration,identity}.rs`,
