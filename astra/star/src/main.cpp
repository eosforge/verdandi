// 功能: 提供 Star 节点可执行程序的启动入口，将 Star 特有的角色标识和策略工厂移交给公共运行时系统。
...
// 连同固定写死的 astra::Role::star 角色和 astra::make_star 工厂方法，
...
int main(int argc, char** argv) {
    ...
    return astra::run_node(argc, argv, astra::Role::star, astra::make_star);
}
