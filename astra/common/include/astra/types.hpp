...
struct Status {
    ...
    static auto configuration(std::string msg) {
        return std::unexpected(Status{Code::configuration, std::move(msg)});
    }
    static auto identity(std::string msg) {
        return std::unexpected(Status{Code::identity, std::move(msg)});
    }
    static auto protocol(std::string msg) {
        return std::unexpected(Status{Code::protocol, std::move(msg)});
    }
    static auto conflict(std::string msg) {
        return std::unexpected(Status{Code::conflict, std::move(msg)});
    }
    static auto capacity(std::string msg) {
        return std::unexpected(Status{Code::capacity, std::move(msg)});
    }
    static auto timeout(std::string msg) {
        return std::unexpected(Status{Code::timeout, std::move(msg)});
    }
    static auto transport(std::string msg) {
        return std::unexpected(Status{Code::transport, std::move(msg)});
    }
    static auto cancelled(std::string msg) {
        return std::unexpected(Status{Code::cancelled, std::move(msg)});
    }
    static auto internal(std::string msg) {
        return std::unexpected(Status{Code::internal, std::move(msg)});
    }
