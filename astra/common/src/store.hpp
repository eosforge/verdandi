...
public:
    ...
    using Buffer = SnapshotIndex::Buffer;
    using Value = SnapshotIndex::Value;
    ...
    struct Snapshot {
        ...
        std::unordered_map<std::string, SnapshotIndex::Record> data;
    };
...
private:
    ...
    static std::shared_ptr<const Store::Snapshot> dump(const SnapshotIndex::View& view, std::uint64_t version);
