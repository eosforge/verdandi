...
当前实现为 [C++26 Star/Planet](../cluster-cpp/README.md) 和 [Go Supervisor](../supervisor/README.md).
身份、命名、协议 v5 和升级边界以[身份与准入契约](identity-contract.md)为准.
