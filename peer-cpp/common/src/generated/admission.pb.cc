...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::verdandi::peer::v1::LoginRequest
        {&::_pbi::kDescriptorMethods, &::descriptor_table_admission_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
namespace verdandi {
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GetTable<::verdandi::peer::v1::LoginRequest>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
      // string advertise = 4;
      {::_pbi::TcParser::FastUS1,
       {34, 3, 0,
        PROTOBUF_FIELD_OFFSET(LoginRequest, _impl_.advertise_)}},
      // string username = 1;
      {::_pbi::TcParser::FastUS1,
       {10, 0, 0,
      ...
      {::_pbi::TcParser::FastUS1,
       {26, 2, 0,
        PROTOBUF_FIELD_OFFSET(LoginRequest, _impl_.cluster_id_)}},
    }}, {{
      65535, 65535
    }}, {{
      // string username = 1;
      ...
      // string cluster_id = 3;
      {PROTOBUF_FIELD_OFFSET(LoginRequest, _impl_.cluster_id_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // string advertise = 4;
      {PROTOBUF_FIELD_OFFSET(LoginRequest, _impl_.advertise_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    }},
    // no aux_entries
    {{
      "\35\10\10\12\11\0\0\0"
      "verdandi.peer.v1.LoginRequest"
      "username"
      "password"
      "cluster_id"
...
constexpr auto LoginRequest::InternalGenerateClassData_(
  ...
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          Super_::GetNewImpl<LoginRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &LoginRequest::SharedDtor,
          Super_::GetClearImpl<LoginRequest>(), &LoginRequest::ByteSizeLong,
      ...
      &descriptor_table_admission_2eproto,
      nullptr,  // tracker
...
const ::uint32_t
    TableStruct_admission_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::verdandi::peer::v1::LoginRequest, _impl_._has_bits_),
        7, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::verdandi::peer::v1::LoginRequest, _impl_.username_),
        PROTOBUF_FIELD_OFFSET(::verdandi::peer::v1::LoginRequest, _impl_.password_),
        PROTOBUF_FIELD_OFFSET(::verdandi::peer::v1::LoginRequest, _impl_.cluster_id_),
        PROTOBUF_FIELD_OFFSET(::verdandi::peer::v1::LoginRequest, _impl_.advertise_),
        0,
        1,
        2,
        3,
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::verdandi::peer::v1::LoginRequest)},
};
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::verdandi::peer::v1::LoginRequest_globals_,
};
const char descriptor_table_protodef_admission_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\017admission.proto\022\020verdandi.peer.v1\032\npee"
    "r.proto\"Y\n\014LoginRequest\022\020\n\010username\030\001 \001("
    "\t\022\020\n\010password\030\002 \001(\t\022\022\n\ncluster_id\030\003 \001(\t\022"
    "\021\n\tadvertise\030\004 \001(\t2\274\001\n\tAdmission\022T\n\tChal"
    "lenge\022\036.verdandi.peer.v1.LoginRequest\032\'."
    "verdandi.peer.v1.RegistrationChallenge\022Y"
    "\n\010Register\022%.verdandi.peer.v1.Registrati"
    "onRequest\032&.verdandi.peer.v1.Registratio"
    "nResponseBAZ\?github.com/eosforge/verdand"
    "i/supervisor/internal/generated;wireb\006pr"
    "oto3"
};
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, LoginRequest_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : Super_(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:verdandi.peer.v1.LoginRequest)
}
PROTOBUF_NDEBUG_INLINE LoginRequest::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::verdandi::peer::v1::LoginRequest& from_msg)
...
LoginRequest::LoginRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:verdandi.peer.v1.LoginRequest)
}
PROTOBUF_NDEBUG_INLINE LoginRequest::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
LoginRequest::~LoginRequest() {
  // @@protoc_insertion_point(destructor:verdandi.peer.v1.LoginRequest)
  SharedDtor(*this);
}
...
PROTOBUF_NOINLINE void LoginRequest::Clear() {
  ...
  // @@protoc_insertion_point(message_clear_start:verdandi.peer.v1.LoginRequest)
...
::uint8_t* PROTOBUF_NONNULL LoginRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:verdandi.peer.v1.LoginRequest)
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_username().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "verdandi.peer.v1.LoginRequest.username");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_password().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "verdandi.peer.v1.LoginRequest.password");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    if (!this_._internal_cluster_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "verdandi.peer.v1.LoginRequest.cluster_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000008U)) {
    if (!this_._internal_advertise().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "verdandi.peer.v1.LoginRequest.advertise");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:verdandi.peer.v1.LoginRequest)
  return target;
}
...
::size_t LoginRequest::ByteSizeLong() const {
  const LoginRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:verdandi.peer.v1.LoginRequest)
  ::size_t total_size = 0;
...
void LoginRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:verdandi.peer.v1.LoginRequest)
...
void LoginRequest::CopyFrom(const LoginRequest& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:verdandi.peer.v1.LoginRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
