    ...
    def __init__(self, options):
        ...
        self.report = {
            ...
            "source_sha256": {
                ...
                for path in (Path(__file__), ROOT / "testkit/services.py", ROOT / "testkit/support.py", ROOT / "cluster-cpp/test_scale.py")
            },
            "limits": [
...
def parse_options(argv=None):
    ...
    parser.add_argument("--binaries", type=Path, default=ROOT / "build/cluster-cpp/release")
